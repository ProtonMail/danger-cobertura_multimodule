...
## Forked Danger module

This project is a fork of [danger-cobertura](https://github.com/Kyaak/danger-cobertura) to work with a multi module project by also parsing the `sources` tags inside the cobertura reports and be able to match the coverage file nodes to the actual fiels included in the MR.
...
**Note**: using this attribute is discouraged as it seemed to be a workaround for the absence of `sources` node parsing. Use at your own risk.
